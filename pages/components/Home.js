              ...
              <div className="card w-100">
                ...
                <div className="card-body">
                  ...
                  <p className="mb-0 mt-3">
                    ...
                    ipsum ac feugiat. Ibulum ullamcorper.aciat. Vestibu ullamer
                    quam. nenatis
                  </p>
                ...
                >
                  <div className="d-flex flex-row comment-row border-bottom p-3">
                    ...
                    <div className="comment-text w-100 p-3">
                      ...
                      <div
                        className="comment-footer d-md-flex align-items-center mt-2"
                      >
                        <span
                          className="
                            badge
                  ...
                  <div
                    className="d-flex flex-row comment-row border-bottom active p-3"
                  >
                    <div className="p-2">
                      <span
                        ><img
      ...
      <div className="customizer-body">
        ...
        <div className="tab-content" id="pills-tabContent">
          ...
          >
            ...
            <div className="p-3 border-bottom">
              <h5 className="font-weight-medium mb-2 mt-2">Logo Backgrounds</h5>
            ...
            <div className="p-3 border-bottom">
              <h5 className="font-weight-medium mb-2 mt-2">Navbar Backgrounds</h5>
              <ul className="theme-color m-0 p-0">
                <li className="theme-item list-inline-item me-1">
                  <a
                    href="javascript:void(0)"
            ...
            <div className="p-3 border-bottom">
              <h5 className="font-weight-medium mb-2 mt-2">Sidebar Backgrounds</h5>
              <ul className="theme-color m-0 p-0">
                <li className="theme-item list-inline-item me-1">
                  <a
                    href="javascript:void(0)"
              ...
              <li>
                <div className="message-center chat-scroll position-relative">
                  ...
                  >
                    ...
                    <div className="w-75 d-inline-block v-middle ps-2">
                      <h5 className="message-title mb-0 mt-1">Akshay Kumar</h5>
                      <span
                        className="
                          fs-2
                          text-nowrap
                  ...
                  >
                    ...
                    <div className="w-75 d-inline-block v-middle ps-2">
                      <h5 className="message-title mb-0 mt-1">Varun Dhavan</h5>
                      <span
                        className="
                          fs-2
                          text-nowrap
            ...
            <div className="steamline">
              <div className="sl-item">
                <div className="sl-left bg-success">
                  <i data-feather="user" className="feather-sm fill-white"></i>
                </div>
              ...
              <div className="sl-item">
                <div className="sl-left bg-info"><i className="fas fa-image"></i></div>
                <div className="sl-right">
              ...
              <div className="sl-item">
                ...
                <div className="sl-right">
                  <div className="font-weight-medium">
                    Go to the Doctor <span className="sl-date">5 minutes ago</span>
                  </div>
